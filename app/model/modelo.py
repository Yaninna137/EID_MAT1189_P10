...
class ModeloCosto:
    ...
    # Curva de nivel
    def calcular_curva_nivel(self, nivel: float):
        """Calcula la curva de nivel para el nivel especificado, resolviendo en funcion de z."""
        ecuacion_nivel = sp.Eq(self.funcion, nivel)
        soluciones = sp.solve(ecuacion_nivel, self.symbols[2])  # Resolvemos para z
        return soluciones
