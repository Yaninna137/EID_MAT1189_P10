...
def main():
    ...
    if paso_activo == 0:
        mostrar_pagina_1(st.session_state.modelo if st.session_state.calculado else None)
    elif paso_activo == 1:
        mostrar_pagina_2(st.session_state.modelo if st.session_state.calculado else None)
    elif paso_activo == 2:
